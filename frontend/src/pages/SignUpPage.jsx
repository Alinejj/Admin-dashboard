...
const SignUpPage = () => {
  ...
  className='max-w-md w-full bg-gray-800 bg-opacity-50 backdrop-filler
  ...
  >
    ...
    <form onSubmit={handleSignUp}>
        ...
        <motion.button className ='mt-5 w-full py-3 px-4 bg-gradient-to-r from-pink-400 to-pink-600 text-white
        font-bold rounded-lg shadow-lg hover:from-pink-400 hover:to-pink-700 focus:outline-none focus:ring-2 focys:ring-pink-400 
